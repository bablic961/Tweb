...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[('text', '💬 Текст'), ('image', '🖼 Фото'), ('video', '🎬 Видео'), ('file', '📎 Файл')], default='text', max_length=10)),
                ('encrypted_text', models.BinaryField(blank=True, help_text='Зашифрованный текст (AES-256)', null=True)),
